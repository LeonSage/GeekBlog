    ...
    <div class="margin">
        ...
        <div class="s-12 l-9">
            ...
            <article class="margin-bottom">
                <!-- text -->
                <div class="post-text">
                    <h1>Add your articles</h1>
                    <div class="container">
                    <form:form class="customform" action="/admin/blogs/addP" method="post" commandName="blog" role="form">
                        ...
                        <div class="form-group">
                            <input class="form-control" id='userByUserId.id' name="userByUserId.id" type="hidden" value="${userId}"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="150" cols="50" class="form-control" id="froala-editor" name="content" rows="3" placeholder="Please Input Content"></textarea>

                        </div>

                        <%--product the current date--%>
                        <div class="form-group">
                            <script>
